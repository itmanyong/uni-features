...
import type {
  ...
  ManifestHelperDefineUniManifestConfig,
} from "./types";
export * from "./types";
...
export function defineUniManifest<T = UniManifestHelperConfig>(
  config: T | ManifestHelperDefineUniManifestConfig<T>
): T {
  if (typeof config === "function") {
    return (config as ManifestHelperDefineUniManifestConfig<T>)(
      MANIFEST_CONFIG_DEFAULT
    );
  }
  return config;
